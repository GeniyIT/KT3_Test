...
# user = base_request.put('user', 'Artem', user_data) #Изменение пользователя
# pprint.pprint(user)

# user2 = base_request.get('user', 'Artem') #Получение информации о пользователе
# pprint.pprint(user2)

# delete = base_request.delete('user', 'Artem') #Удаление пользователя
# print(delete)